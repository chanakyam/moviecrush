...
welcome(Req, State) ->
	...
	% Url_all_news = moviecrush_util:most_popular_data(Category),
	...
	Url_movies_video = "http://api.contentapi.ws/videos?channel=world_news&limit=1&skip=1&format=long",
	...
	{ok, Body} = most_popular_dtl:render([{<<"videoParam">>,Params1},{<<"allnews">>,Params},{<<"movies">>,ResponseRows_Movies},{<<"movies1">>,ResponseRows_Movies1},{<<"movies2">>,ResponseRows_Movies2},{<<"movies3">>,ResponseRows_Movies3},{<<"movies5">>,ResponseRows_Movies5},{<<"interviews">>,ResponseRows_Interviews},{<<"imagegallery1">>,ResponseRows_ImgGallery1}]),
    {Body, Req, State}.
