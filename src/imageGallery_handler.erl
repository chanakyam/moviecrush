...
welcome(Req, State) ->
	...
	% Url_all_news = "http://api.contentapi.ws/news?channel=entertainment_music&limit=14&format=short&skip=0",
	Url_all_news = "http://contentapi.ws:5984/contentapi_text_maxcdn/_design/yb_entertainment_music/_view/short?descending=true&limit=14&skip=0",
	...
	{ok, Body} = photo_gallery_dtl:render([{<<"videoParam">>,ResponseRows_movies_video},{<<"allnews">>,ResAllNews},{<<"movies5">>,ResponseRows_Movies5},{<<"interviews">>,ResponseRows_Interviews},{<<"interviews1">>,ResponseRows_Interviews1}]),
    {Body, Req, State}.
